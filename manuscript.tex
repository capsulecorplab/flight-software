...
The following \ref{stakeholder-needs-mapping}, PLACEHOLDER TABLE, and PLACEHOLDER TABLE are all automatically generated using the M30ML structure and injected directly into this article. Should any changes be made to the SeaLion architecture repository, the tables can be immediately regenerated for continous updates.
...
\begin{figure}[hbt!]
    ...
    \caption{a view describing mapping of stakeholders to stakeholder needs in UML}
