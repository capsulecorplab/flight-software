...
* xref:sealion-mission-architecture#_2_view_satellite_health_data_packet[View Satellite Health Data Packet]
...
* xref:sealion-mission-architecture#_4_request_telemetry_data[Request Telemetry Data]
...
* xref:sealion-mission-architecture#_4_2_request_satellite_aods_sensor_data[Request Satellite AODS Sensor Data]
